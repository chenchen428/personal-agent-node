...
Beta 用户只需要下载对应系统的完整安装包，不需要预装 Node.js、npm、开发助手或克隆源码。当前发行版为 `v0.2.0-beta.11`：

- Windows x86-64：`personal-agent-node-v0.2.0-beta.11-windows-x64-installer.exe`
- macOS Apple Silicon：`personal-agent-node-v0.2.0-beta.11-macos-arm64.pkg`
- macOS Intel：`personal-agent-node-v0.2.0-beta.11-macos-x64.pkg`
- Linux x86-64 / ARM64：对应的 `personal-agent-node-v0.2.0-beta.11-linux-*.tar.zst`
