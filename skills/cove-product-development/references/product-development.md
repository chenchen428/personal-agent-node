...
Cove product development is not Workspace self-iteration.

- Workspace self-iteration improves user-owned Skills and workflows under
  the installed Agent workspace.
- Product development changes the private Cove root repository,
...
4. Never edit the installed `core/current` release and keep user skill iteration separate from product source changes.
