...
description: Apply the portable customer-machine acceptance standard for Cove Node. Use for milestone, release, final delivery, installation, upgrade, rollback, Console, CLI, permission, connection, Pages, task, or optional Managed Cloud acceptance decisions.
---
