---
name: cove-connections
description: Inspect, configure, clear, and safely use Cove service connections. Use for WeChat claw, DingTalk, personal WeChat, Xiaohongshu, Twitter or X, Notion, local mail, Sites, connector status, browser-backed reads, account authorization, or connection-specific operations.
---
...
For historical compatibility boundaries, read [channels.md](references/channels.md). Use the Xiaohongshu or Twitter/X connector reference for browser reads; no separate specialist skill is required.
