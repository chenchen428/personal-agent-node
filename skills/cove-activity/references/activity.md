...
Activity and Memory are separate products. Search Activity for user-visible work outcomes and governed destinations. Use the `cove-memory` skill only for durable Space-local facts, preferences, and continuing constraints; never copy Activity automatically into Memory.
