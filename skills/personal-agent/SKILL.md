...
Follow the R0-R3 model in [safety-and-confirmation.md](references/safety-and-confirmation.md). R2 and R3 work requires a plan and an approval made by the user through the trusted direct-loopback local console or interactive local TTY. A non-interactive Agent cannot approve its own operation.
