---
name: cove-data
description: Inspect and query current-Space Cove data through pa-cli data. Use for data status, schema discovery, safe SQL or structured queries, metadata, snapshots, restore planning, aggregates, pagination, or explaining locally governed data results.
---
