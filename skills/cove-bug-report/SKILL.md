---
name: cove-bug-report
description: Draft, de-duplicate, submit, comment on, and verify public GitHub bug reports for Cove Node using the customer's active GitHub CLI identity. Use when the user asks to report a Node bug, submit product feedback, create an issue, or add evidence to an existing public issue.
---
