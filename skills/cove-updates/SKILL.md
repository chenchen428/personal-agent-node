---
name: cove-updates
description: Check, plan, apply, verify, and roll back Cove client updates. Use for available-version checks, digest-bound update plans, restart handoff, persisted update jobs, previous-release rollback, failed-update recovery, or product-development-authorized client updates.
---
