...
export function loadLegacyInteriorTemplateContract(skillRoot) {
  const current = loadInteriorTemplateContract(skillRoot);
  return {
    ...structuredClone(current),
    implementation: {
      ...current.implementation,
      version: 1,
      generator: 'node skills/interior-design/scripts/cli.mjs page --template interior-design-delivery --source-plan <redacted-user-floor-plan> --input <v1-model.json> --output <page-dir> --json',
    },
  };
}
