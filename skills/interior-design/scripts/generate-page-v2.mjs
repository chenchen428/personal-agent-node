...
export function verifyProfessionalPageHtml({ html, threeDHtml }, delivery) {
  ...
  if (/data-style-profile|style-picker|style-control|setStyleProfile|pascal-style-change/i.test(threeDHtml)) {
    throw new Error('3D specialist Page must render only the Agent-selected style and expose no client-side style switching');
  }
