...
<nav class="presentation-switch" aria-label="装修设计资料切换"><button class="active" type="button" data-presentation="model">SU 设计稿</button><button type="button" data-presentation="plan">户型图</button><button type="button" data-presentation="requirements">用户需求</button><button type="button" data-presentation="review">质量</button></nav>
