...
Set `TAG=v0.2.0-beta.27` and open the matching [GitHub Release](https://github.com/chenchen428/personal-agent-node/releases/tag/v0.2.0-beta.27). A customer machine does not need Node.js, npm, Git, a source checkout, or a development Agent.
...
| Linux x86-64 | `personal-agent-node-v0.2.0-beta.27-linux-x64.tar.zst` |
| Linux ARM64 | `personal-agent-node-v0.2.0-beta.27-linux-arm64.tar.zst` |
