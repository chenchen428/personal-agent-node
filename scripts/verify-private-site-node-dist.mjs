...
function verifyLayout() {
  ...
  assert(manifest.harness?.agentCatalog === "workspace/registry/agents.json" && manifest.harness?.agents === "workspace/agents", "Specialist Agent distribution contract is missing");
  ...
  for (const relative of [
    ...
    "workspace/AGENTS.md", "workspace/skills", "workspace/agents", "workspace/agents/video-creator/AGENT.md", "workspace/agents/video-creator/STYLE-GUIDE.md", "workspace/agents/video-creator/styles.json", "workspace/agents/travel-planner/AGENT.md", "workspace/agents/travel-planner/agent.yaml", "workspace/workflows", "workspace/workflows/product-development.md", "workspace/registry/skills.json", "workspace/registry/agents.json", "workspace/registry/plugins.json", "workspace/registry/product-development.json", "workspace/schemas/personal-agent/agents.schema.json", "workspace/schemas/personal-agent/video-styles.schema.json", "workspace/scripts/agent-guard.mjs",
...
function verifyPreparation() {
  ...
  try {
    ...
    for (const relative of ["AGENTS.md", "skills", "agents", "workflows", "registry"]) {
