...
checks.push({ name: 'historical projects layer removed', ok: !exists('projects') });
checks.push({ name: 'core/workspace delivery registry', ok: exists('registry/delivery.json') });
report(checks);
