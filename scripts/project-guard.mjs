...
const checks = [];
const names = new Set();
for (const dir of ['projects/core/node', 'projects/core/edge', 'projects/core/open-agent-bridge', 'registry', 'scripts', 'skills', 'workflows', 'test/fixtures']) checks.push({ name: `required path ${dir}`, ok: exists(dir) });
