...
This checkout targets GitHub prerelease `v0.2.0-beta.63`, fixing CLI workspace routing and Windows Page share links, with calendar and workspace refinements, shared runtime settings, skill management and conversation recovery.

Download the matching published release assets for your platform; Windows and macOS packages retain the disclosed unsigned prerelease status.
...
Beta users download one complete package for their operating system. No preinstalled Node.js, npm, development Agent, or source checkout is required. The current release is `v0.2.0-beta.63`:

- Windows x86-64: `personal-agent-node-v0.2.0-beta.63-windows-x64-installer.exe`
- macOS Apple Silicon: `personal-agent-node-v0.2.0-beta.63-macos-arm64.pkg`
- macOS Intel: `personal-agent-node-v0.2.0-beta.63-macos-x64.pkg`
- Linux x86-64 / ARM64: the matching `personal-agent-node-v0.2.0-beta.63-linux-*.tar.gz`
