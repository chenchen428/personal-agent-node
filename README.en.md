...
Beta users download one complete package for their operating system. No preinstalled Node.js, npm, development Agent, or source checkout is required. The current release is `v0.2.0-beta.6`:
...
- Linux x86-64 / ARM64: the matching `personal-agent-node-v0.2.0-beta.6-linux-*.tar.zst`
