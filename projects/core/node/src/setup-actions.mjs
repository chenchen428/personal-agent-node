...
import { writePasswordVerifier } from '../../open-agent-bridge/src/auth/personal-auth.js';
import { removeSecretEnvKeys, resolveNodeConfig, writeJsonAtomic, workspaceRoot } from './config.mjs';
...
function launchManagedCloudSetup({ dataRoot }) {
  ...
  const cli = path.join(workspaceRoot, 'projects', 'core', 'node', 'bin', 'personal-agent.mjs');
