...
test("Next.js owns the approved V6.39 mobile client and V7.3 desktop workspace", () => {
  ...
  assert.ok(navigation.indexOf('label: "Agent 组件"') < navigation.indexOf('href: "\/app\/workers\/plans"'));
  ...
  assert.match(read("core/app/src/components/desktop-v627/plans-page.tsx"), /const activeId =/);
  ...
  assert.match(taskViewNavigation, /\/plans/);
  ...
  assert.match(read("core/app/src/components/desktop-v627/plans-page.tsx"), /TaskModuleViewNavigation active="plans"/);
