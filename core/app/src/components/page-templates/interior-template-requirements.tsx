const groups = [
  { title: "空间结构", items: ["拟拆除餐厅右侧、生活阳台下方卧室的待核验隔墙", "该卧室并入公共区，形成大客厅", "左下角靠凸窗卧室保留", "墙厚约 220mm，实施前现场复测并复核结构条件"] },
  { title: "生活习惯", items: ["满足六人就餐与多人会客", "生活阳台保留洗烘与家政收纳", "书房兼顾日常办公和临时客房"] },
  { title: "设计偏好", items: ["现代温润，减少高饱和装饰", "南向阳台保持通透，强化落地窗", "Pascal 模型需标清门窗、柜体和关键净宽"] },
];
...
export function InteriorTemplateRequirements() {
  return <section className="interior-requirements-view">
    ...
    <p>拆除餐厅右侧、生活阳台下方卧室的待核验隔墙，把该卧室并入公共区形成大客厅；保留左下角靠凸窗卧室。墙厚约 220mm 为图纸记录，拆改前必须现场复测并由结构专业人员确认。</p>
