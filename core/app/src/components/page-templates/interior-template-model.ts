...
export const interiorRooms: InteriorRoom[] = [
  { id: "living", name: "大客厅", note: "会客核心", x: 3.2, z: 6.2, width: 6.2, depth: 4.3, floor: "#caa979" },
  ...
  { id: "second", name: "次卧", note: "靠凸窗保留", x: 6.8, z: 2.0, width: 3.4, depth: 3.7, floor: "#d8c19b" },
  { id: "living-extension", name: "大客厅延展区", note: "餐厅右侧卧室并入", x: 10.0, z: 2.0, width: 2.8, depth: 3.7, floor: "#caa979" },
...
export const interiorFurniture: InteriorFurniture[] = [
  ...
  { id: "extension-sofa", roomId: "living-extension", kind: "sofa", x: 10.0, z: 2.1, width: 2.2, depth: 0.9, height: 0.72, color: "#d9d2c6" },
