...
export function WorkersPage() {
  const { sessions, selected, select } = useWorkerSessions();
  ...
  return <main className="v72-page v72-page-flush"><div className="v72-split-view">
    <aside className="v72-split-list" aria-label="任务列表">
