...
export function UpdatePage() {
  ...
  const post = <T = any,>(action: string, body: object = {}) => fetchJson<T>("/api/system/update", { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ action, ...body }) });
