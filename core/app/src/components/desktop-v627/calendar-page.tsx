...
export function CalendarPage() {
  ...
  return <PageSurface className="cove-calendar"><PageHeader title="任务" description="按时间查看计划的每次安排，追踪提醒与执行结果。" actions={<Button onClick={() => void calendar.refresh()} aria-label="刷新日程"><RefreshCw size={15} />刷新</Button>} />
    <TaskModuleViewNavigation active="calendar" />
