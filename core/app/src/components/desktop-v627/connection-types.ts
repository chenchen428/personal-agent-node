...
export type Connection = {
  ...
  loginUrl?: string;
  details?: { inherited?: boolean; inheritedFromSpaceId?: string; inheritedBaseDomain?: string; browserReady?: boolean; loginState?: "logged_in" | "logged_out" | "unknown"; searchReady?: boolean; readReady?: boolean; checkedAt?: string; configured?: boolean; clientId?: string; lastConnectedAt?: string; lastInboundAt?: string; platformDomainBound?: boolean; bindingMode?: "platform" | "custom" | ""; platformDomain?: string; customDomain?: string; customServer?: string; customPublicAddress?: string; customServiceReady?: boolean; customRelayCredentialPrepared?: boolean; customRelayInstallerUrl?: string; mailAddress?: string; publicReady?: boolean; publicStatus?: "ready" | "tunnel-offline" | "unavailable" | "not-bound"; publicReason?: string; publicOrigin?: string; domainVerification?: DomainVerification; policyEnabled?: boolean; connectivityTestPassed?: boolean };
};
