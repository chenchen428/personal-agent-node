...
import { CodexRuntimeSetting } from "./codex-runtime-setting";
...
export function SettingsPage() {
  ...
  return <SettingsLayout active="general"><div className="settings-inner"><h1>通用</h1><p>管理当前空间中的 Personal Agent 行为。桌面客户端始终作为本机可信入口。</p>
    ...
    <h2 className="settings-section-title">Agent 执行</h2><Card className="setting-group"><CodexRuntimeSetting /></Card>
