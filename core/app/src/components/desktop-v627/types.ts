...
export type Message = { id: string; sessionId?: string; role: string; content: string; createdAt?: string; metadata?: { attachments?: ConversationAttachment[]; clientMessageId?: string; optimistic?: boolean; channel?: string; sourceLabel?: string } };
