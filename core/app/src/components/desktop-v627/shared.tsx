...
export function desktopActivityHref(item: ActivityItem) { if (item.kind === "conversation") return "/app/conversations"; if (item.kind === "work") return "/app/workers"; if (item.kind === "mail") return "/app/mail"; if (item.kind === "page") return "/app/pages"; if (item.kind === "automation") return "/app/connections"; return "/app/data"; }
