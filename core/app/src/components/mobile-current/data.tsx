...
export function groupSkills(skills: Skill[]) { return [{ name: "内置技能", skills: skills.filter((skill) => skill.source?.kind === "builtin") }, { name: "我的技能", skills: skills.filter((skill) => skill.source?.kind !== "builtin") }].filter((group) => group.skills.length); }
