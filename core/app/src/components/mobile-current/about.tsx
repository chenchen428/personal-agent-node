...
export function MobileAbout() {
  ...
  return <MobileListShell section="about" title="关于" note="你的 PA">
    <div className="mobile-about">
      <section className="mobile-about-machine"><span className="mobile-about-mark">PA</span><div><span>当前机器</span><h1>{overview.value?.machine.id || "正在读取本机信息"}</h1><p>本机运行 · 最近检查：刚刚</p></div><em>{overview.value?.machine.state === "running" ? "在线" : "检查中"}</em></section>
