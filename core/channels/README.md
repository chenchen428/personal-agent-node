...
Channel cookies, QR sessions, browser profiles, downloaded binaries, caches, and logs belong under `PRIVATE_SITE_DATA_ROOT/channels` or `PRIVATE_SITE_DATA_ROOT/runtime`; they are never committed or packaged as shared data.
